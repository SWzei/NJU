...
const messages = {
  zh: {
    ...
    classMatching: {
      ...
      modeDirect: "直接互选",
      modeRanking: "偏好排序",
      modeDirectHint: "直接互选：你与被选择对象双向确认后，系统会直接锁定配对，不再进入算法分配。",
      modeRankingHint: "偏好排序：为心仪对象排序，算法将结合时间重叠、校区、费用与水平兼容度自动计算最优匹配。",
      campus: "校区",
      campusFromProfile: "当前校区：{campus}（来自用户资料）",
      needsCampus: "用户资料中未填写校区，请在此处补充，以便参与匹配算法。",
      ...
      feeMax: "最高课费",
      feeUnit: "单位：元/小时",
      studentSkillLevel: "钢琴水平",
      teacherSkillRange: "可教学生水平范围",
      teacherSkillRangeText: "{min} 至 {max}",
      skillLabel0: "零基础",
      skillLabel1: "业余一级",
      skillLabel2: "业余二级",
      skillLabel3: "业余三级",
    ...
    concerts: {
      ...
      auditionInfoTitle: "审核信息",
      noAuditionInfo: "当前音乐会暂无已发布的审核信息。",
      auditionTimeLabel: "审核时间",
      auditionResultLabel: "审核结果",
      auditionResultPending: "待审核",
      auditionResultPassed: "通过",
      auditionResultFailed: "不通过",
      auditionFeedbackLabel: "反馈",
      auditionReasonLabel: "不通过理由",
    },
    concertStatus: {
      draft: "草稿",
      open: "报名中",
    ...
    admin: {
      ...
      editConcertHint: "已进入编辑模式，修改后可保存、发布或删除该音乐会。",
      ...
      programArrangementTitle: "节目安排",
      availableProgramsTitle: "已通过节目池",
      noAvailablePrograms: "暂无可用节目。",
      segmentsTitle: "场次编排",
      addSegment: "增加场次",
      removeSegment: "删除场次",
      segmentName: "场次名称",
      restAfterMin: "场次后休息（分钟）",
      intervalBeforeMin: "与前节目间隔（分钟）",
      moveUp: "上移",
      moveDown: "下移",
      addToSegment: "添加到场次",
      removeFromSegment: "移除",
      noSegments: "暂无场次，请先增加场次。",
      noItemsInSegment: "该场次暂无节目。",
      totalProgramCount: "总节目数量",
      totalProgramDuration: "总节目用时",
      totalActualDuration: "总实际用时",
      saveProgramArrangement: "保存整场安排",
      programArrangementSaved: "节目安排已保存。",
      programArrangementLoadFailed: "节目安排加载失败。",
      programArrangementSaveFailed: "节目安排保存失败。",
      viewScoreFile: "查看乐谱",
      submittedAt: "提交时间",
      updatedAt: "更新时间",
      ...
      confirmDeleteSemester: "确认删除当前学期及其全部琴时数据吗？",
      ...
      confirmDeleteConcert: "确定要永久删除这场音乐会及其所有的报名信息吗？",
      concertUnsavedBeforeRelease: "请先保存当前音乐会修改，再执行发布。",
      concertRequired: "请先选择音乐会。",
      applicationRequired: "请先选择申请。",
      auditionTitle: "创建/编辑音乐会审核周期",
      auditionSubtitle: "为选定音乐会创建或编辑审核周期，用于发布线下节目审核信息。",
      auditionListTitle: "管理已创建审核周期",
      noAuditions: "暂无审核周期。",
      auditionTime: "审核时间",
      auditionStatus: "审核状态",
      saveAudition: "保存审核周期",
      releaseAudition: "发布审核通知",
      deleteAudition: "删除审核",
      auditionReleaseMessage: "发布通知内容（选填）",
      confirmReleaseAudition: "确认发布该审核通知并发送给已报名用户吗？",
      auditionCreated: "审核周期创建成功，ID：{id}。",
      auditionUpdated: "审核周期已更新。",
      auditionDeleted: "审核周期已删除。",
      auditionReleased: "审核通知已发布，发送：{count}。",
      auditionResultTitle: "审核结果",
      auditionStatusPending: "待审核",
      auditionStatusPassed: "通过",
      auditionStatusFailed: "不通过",
      auditionFeedback: "审核反馈 / 不通过理由",
      auditionFeedbackRequired: "不通过时必须填写理由。",
      saveAuditionResult: "保存审核结果",
      auditionResultSaved: "审核结果已保存。",
    ...
    adminClassMatching: {
      ...
      confirmDeleteTerm: "确认删除当前匹配学期及其全部匹配数据吗？",
      termDeleted: "匹配学期已删除。",
      termDeleteFailed: "匹配学期删除失败。",
      summaryTitle: "匹配概览",
      ...
      teacherCampus: "校区",
      teacherFeeRange: "课费范围",
      teacherSkillRange: "可教学生水平",
      notProvided: "未填写",
      teacherCapacity: "容量",
    ...
    imslp: {
      ...
      tabPeople: "搜索人物",
      workTitle: "作品名称",
      workTitlePlaceholder: "例如：Sonata",
      composer: "作曲家",
      composerPlaceholder: "例如：Mozart",
      personName: "姓名",
      personNamePlaceholder: "例如：Mozart",
      search: "搜索",
      searchFailed: "搜索失败。",
      loadDetailFailed: "详情加载失败。",
      backToSearch: "返回搜索",
      scoreFiles: "乐谱文件",
      noScores: "暂无乐谱文件。",
      noResults: "未找到匹配结果。",
      noCategoryTables: "暂无分类作品列表。",
      pageCount: "{count} 页",
      downloadCount: "下载 {count} 次",
      rating: "评分 {rating}（{count} 人）",
      fileSize: "大小 {size}",
      metadata: "作品信息",
      period: "时期",
      type: "体裁",
      ...
      instruments: "乐器",
      totalWorks: "作品总数",
      typeDistribution: "体裁分布",
      instrumentDistribution: "乐器分布",
      periodBaroque: "巴洛克",
      periodClassical: "古典主义",
      periodRomantic: "浪漫主义",
      periodModern: "现代",
    },
  },
